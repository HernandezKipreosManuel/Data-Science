...
# Recibimos en la entrada la imagen y salida decirnos a que categoría pertenece
# La red neuronal convolucional es muy utilizada para clasificación de imagenes.
...
# Normalizar los datos (Pasar de 0-255 a 0-1) (Osea hacer que todas las entradas sean números entre 0 y 1, 0-255 porque son los valores de los pixeles)
...
#Agregar a cache (usar memoria en lugar de disco, entrenamiento mas rápido)
...
# Le pedimos que entrene en lotes
TAMAÑO_LOTE = 32
